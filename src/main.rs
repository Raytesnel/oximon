...
mod tests {
    ...
    fn movement_diagonal_directions() {
        let cases = vec![
            ...
            (vec![KeyCode::KeyW, KeyCode::KeyA], Vec3::new(-1.0, 1.0, 0.0)),
            (vec![KeyCode::KeyS, KeyCode::KeyD], Vec3::new(1.0, -1.0, 0.0)),
            (vec![KeyCode::KeyS, KeyCode::KeyA], Vec3::new(-1.0, -1.0, 0.0)),
        ];
